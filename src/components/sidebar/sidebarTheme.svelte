...
<div class="sidebar-theme">
    <button type="button" class="sidebar-theme__value" onclick={() => updateCookie(theme)} aria-label="theme">
        <img class="sidebar-theme__img" src={theme === 'dark' ? moon : sun} alt="theme"/>
    </button>
</div>
